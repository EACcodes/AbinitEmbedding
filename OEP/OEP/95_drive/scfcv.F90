...
!====== OEP: check the quit signal status
 logical dovtorho
 integer realquit
!====== END OEP
...
!!=====================================
!!=====  FLORIAN : TRAP THE CODE HERE ====
!!=====================================

  call decider(afford, atindx, &
...
!!=====================
!!  bfgs_loop decides whether to do vtorho
!!=====================
  if (dovtorho) then
